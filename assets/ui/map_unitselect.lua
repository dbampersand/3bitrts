function setup()
    ...
    CreateObject("assets/enemies/kobold_crystal/kobold_crystal.lua",256,256,TYPE_ENEMY,0);
    --CreateObject("assets/enemies/kobold_foreman/kobold_foreman.lua",256,256,TYPE_ENEMY,0);
