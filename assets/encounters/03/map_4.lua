function setup()
    ...
    SetAggroGroup(CreateObject("assets/enemies/kobold_wizard/kobold_wizard.lua",280.00,893.00,TYPE_ENEMY,0.00),1)
    SetAggroGroup(CreateObject("assets/enemies/kobold_wizard/kobold_wizard.lua",416.00,889.00,TYPE_ENEMY,0.00),1)
    SetAggroGroup(CreateObject("assets/enemies/skeleton_basher/skeleton_basher.lua",340.00,881.00,TYPE_ENEMY,0.00),1)
