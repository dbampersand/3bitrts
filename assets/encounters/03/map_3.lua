...
function setup()
    ...
    SetAggroGroup(CreateObject("assets/enemies/kobold_crossbow/kobold_crossbow.lua",240.00,88.00,TYPE_ENEMY,0.00),5)
    SetAggroGroup(CreateObject("assets/enemies/kobold_crossbow/kobold_crossbow.lua",251.00,39.00,TYPE_ENEMY,0.00),5)
    SetAggroGroup(CreateObject("assets/enemies/kobold_crossbow/kobold_crossbow.lua",229.00,63.00,TYPE_ENEMY,0.00),5)
    SetAggroGroup(CreateObject("assets/enemies/exploding_zombie/exploding_zombie.lua",168.00,110.00,TYPE_ENEMY,0.00),6)
    SetAggroGroup(CreateObject("assets/enemies/exploding_zombie/exploding_zombie.lua",143.00,91.00,TYPE_ENEMY,0.00),6)
