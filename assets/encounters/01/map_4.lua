...
function setup()
    ...
    SetAggroGroup(CreateObject("assets/enemies/rock_tosser/rock_tosser.lua",120,182,TYPE_ENEMY,0),1);
    SetAggroGroup(CreateObject("assets/enemies/kobold_crossbow/kobold_crossbow.lua",120,190,TYPE_ENEMY,0),1);
