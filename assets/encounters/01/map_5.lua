function setup()
    ...
    SetAggroGroup(CreateObject("assets/enemies/kobold_wizard/kobold_wizard.lua",136.00,224.00,TYPE_ENEMY,0.00),4)
    ...
    SetAggroGroup(CreateObject("assets/enemies/rock_tosser/rock_tosser.lua",108.00,220.00,TYPE_ENEMY,0.00),4)
