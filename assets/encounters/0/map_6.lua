function setup()
    ...
    SetAggroGroup(CreateObject("assets/enemies/kobold_miner/kobold_miner.lua",228.00,293.00,TYPE_ENEMY,0.00),4)
    SetAggroGroup(CreateObject("assets/enemies/kobold_foreman/kobold_foreman.lua",220.00,264.00,TYPE_ENEMY,0.00),4)
    SetAggroGroup(CreateObject("assets/enemies/kobold_miner/kobold_miner.lua",122.00,246.00,TYPE_ENEMY,0.00),4)
